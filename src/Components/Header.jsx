    ...
    <>
      ...
      <AppBar position="static" sx={{backgroundColor:'#0e0c0a'}}>
        <Toolbar>
          ...
          <Link to={'/all-resumes'} className='text-decoration-none text-light fw-bolder'>ALL RESUMES</Link>
          <Link to={'/download'} className='text-decoration-none text-light fw-bolder mx-5'>ALL DOWNLOADS</Link>
