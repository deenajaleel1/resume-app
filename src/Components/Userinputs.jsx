    ...
    switch(stepCount){
      ...
      case 3: return(
        <p>Our AI will generate Skills & Summary according to your job role.
          Once the form get submitted, user won't get the chance to update the resume details. 
          If you want ot proceed please click the <b>Generate AI Skill & Summary</b> button to submit. </p>
      )
      break;
      default : return null
      break;
        ...
        <React.Fragment>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
            ...
            <Box sx={{ flex: '1 1 auto' }} />
              ...
              {activeStep === steps.length - 1 ? <Button onClick={generateSkills}>Generate AI Skills and Summary</Button> :
